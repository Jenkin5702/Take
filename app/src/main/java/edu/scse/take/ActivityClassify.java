...
import edu.scse.take.ternsorflow.Classifier;
import edu.scse.take.ternsorflow.TensorFlowImageClassifier;
 ...
 * @author baishixian
 */
public class ActivityClassify extends AppCompatActivity implements View.OnClickListener {
    ...
    MessageQueue.IdleHandler idleHandler = new MessageQueue.IdleHandler() {
        ...
        public boolean queueIdle() {
            ...
            if (classifier == null) {
                // 创建 Classifier
               classifier = TensorFlowImageClassifier.create(ActivityClassify.this.getAssets(),
    ...
    private void showNeedStoragePermissionDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override public void onClick(DialogInterface dialog, int which) {
                        ActivityCompat.requestPermissions(ActivityClassify.this,
    ...
    private void handleInputPhoto(Uri imageUri) {
        // 加载图片
        GlideApp.with(ActivityClassify.this).asBitmap().listener(new RequestListener<Bitmap>() {

            @Override
            public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Bitmap> target, boolean isFirstResource) {
                Log.d(TAG,"handleInputPhoto onLoadFailed");
                Toast.makeText(ActivityClassify.this, "图片加载失败", Toast.LENGTH_SHORT).show();
                return false;
            }
